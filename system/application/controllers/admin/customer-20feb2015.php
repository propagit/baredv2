...
Case Construction Online Merchandise Store
	...
	function exportcustomer() {
		...
		if($type==1)
		{
			$headings = array('Username','First Name','Last Name','Email','Date of Birth','Address 1','Address 2','Suburb','State','Country','Postcode','Heard Us');
		fputcsv($fp,$headings);
			foreach ($users as $user) 
			{
				...
				fputcsv($fp,array($user['username'],$customer['firstname'],$customer['lastname'],$customer['email'],$customer['date_dob'].'-'.$customer['month_dob'],$customer['address'],$customer['address2'],$customer['suburb'],$state,$customer['country'],$customer['postcode'],$heard_us));
			}
		}
		elseif($type==2)
		{
