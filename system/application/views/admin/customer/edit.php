...
jQuery(function() {
	...
	<?
		if($this->session->flashdata('push_order')=='push')
		{
			?>$('#any_message').html("The order has been succesfully send to Lightspeed");
			$('#anyModal').modal('show');<?
		}
		else if($this->session->flashdata('push_order')=='nopush')
		{
			?>$('#any_message').html("This customer does not have any open order");
			$('#anyModal').modal('show');<?
		}
	?>
	...
	<div style="min-height: 365px; border: 1px solid #d6d6d6; border-radius: 5px; margin-right: 19px;">
		...
		<div style="padding: 20px">
			...
			<div style="float:none;">
				  <h2 style="float:left; width: 20%; ">Personal Details</h2> 
                <button style="float:left; margin-top:10px; " class="btn btn-primary" type="button" onclick="window.location = '<?=base_url()?>admin/order/order_customer/<?=$customer['id']?>';">
                View Order
                </button>
                
                <button style="float:left; margin-top:10px; margin-left:15px;" class="btn btn-primary" type="button" onclick="window.location = '<?=base_url()?>lightspeed/push_order/<?=$customer['id']?>';">
                Push Open Orders to Lightspeed
                </button>
			</div>
            <div style="clear:both;"></div>
			<form method="post" action="<?=base_url()?>admin/customer/update_retailer" autocomplete="off">
            ...
            <div>
				...
				<select class="selectpicker"  name="title" id="title">
                    ...
                    <option value="Mr" <?=$customer['title'] == 'Mr' ? 'selected="selected"' : '';?>>Mr</option>
                     <option value="Miss" <?=$customer['title'] == 'Miss' ? 'selected="selected"' : '';?>>Miss</option>
           ...
           <div style="height: 5px; clear: both">&nbsp;</div>
			...
			<div>
				...
				<div style="width: 20%; float: left; height: 30px; line-height: 30px;">
                	Lightspeed Customer ID</div>

				<div style="width: 80%; float: right">

					<input style="width: 97%" type="text" class="textfield rounded" name="lightspeed_id" value="<?=$customer['lightspeed_id']?>"/>
			...
			<div>
				...
				<div style="width: 20%; float: left; height: 30px; line-height: 30px;">Heard about us </div>
				...
				<div style="width: 80%; float: right">
					...
					<?php
						...
						{
							echo " (".$customer['personal_referral'].")";
						}
					?>
