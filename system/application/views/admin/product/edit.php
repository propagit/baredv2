		...
		<div style="padding: 20px">
			...
			<div>
				...
				<div id="multi_stock" style="width: 80%; float: right; display: none">
                    ...
                    <!-- 48 eu -->
                    <? $stock48 = str_replace('#','',$multiple_stock_id['48eu']);?>
                    <div style="float: left; width: 15%">
						Size 48 EU
					</div>
					<div style="float: left; width: 30%">
						<input style="width: 100%" type="text" class="textfield rounded" id="48eu" name="48eu" value="<?=$multiple_stock['48eu']?>"/>
					</div>
					<div style="float: left; width: 7%">
						&nbsp;
					</div>
					...
					<div style="float: left; width: 30%">
						<input style="width: 100%" type="text" class="textfield rounded" id="s_48eu" name="s_48eu" value="<?=$stock48?>"/>
					</div>
                    <div style="height: 5px; clear: both">&nbsp;</div>
                    <!-- end 48 eu -->
