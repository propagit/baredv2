<script type="text/javascript" src="<?=base_url()?>js/jquery-jsortable.js"></script>
<script>
$(function() {       
	//getcats();
	//getcats2(); 
...
function searchproduct() {	
	...
	jQuery.ajax({
		url: '<?=base_url()?>admin/position/searchproductposition',
		type: 'POST',
...
<div class="span9">
	<div style="min-height: 365px; border: 1px solid #d6d6d6; border-radius: 5px; margin-right: 19px;">
		<div style="padding: 20px">
			<!-- start here -->
			<h1 style="padding-left: 7px">Manage Products Position</h1>
                ...
                <div class="box bgw">
                    ...
                    <div style="padding-left: 7px;">
                        ...
                        <div style="width: 80%; float: right">                                        
                            ...
                            <?php $sub = $this->Position_model->get_sub_category($maincat['id']);
