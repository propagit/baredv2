		...
		<div style="padding: 20px">
            ...
            <div style="float:none;">
                ...
                <div style="float:right; margin-top:15px;margin-right:10px;" >
                    ...
                    <a style="text-decoration:none" target="_blank" href="<?=base_url()?>admin/cms/edit_promo/<?=$pages['promotion_id']?>">
                    	<button class="btn btn-primary" type="button">Preview</button>
                    </a>
                    
                    <button class="btn btn-primary" onclick="window.location='<?=base_url()?>admin/cms/edit_promo/<?=$pages['promotion_id']?>'" type="button">Back</button>
                </div>
            </div>
            <div style="clear:both;"></div>
			<form name="updateForm" method="post" action="<?=base_url()?>admin/store/updatepromotionpagehtml" enctype="multipart/form-data">

			<input type="hidden" id="id" name="id" value="<?=$pages['id']?>">
            <input type="hidden" id="promotion_id" name="promotion_id" value="<?=$pages['promotion_id']?>">
