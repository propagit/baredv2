...
<style>
.gallery_title{
	margin-top:10px;font-family: 'Lato';font-size: 14px;text-align: center;font-weight:600;margin-bottom:10px;
}
.thumbnails > li{
                                        ...
                                        <div class="span4" style="margin-left:0px!important;">
                                            <div style="text-align: center;" class="gallery slideshow">                                            	                                                                                                
													...
													if (count($photos) == 0 && $gallery['thumbnail']==0) {
													   echo '<a class="img_display" href="'.base_url().'img/thumbnail-no-image.jpg"><img width="30%" src="'.base_url().'img/thumbnail-no-image.jpg" title="'.$gallery['title'].'" /></a>';
														...
														<? if($gallery['thumbnail']==1){
															$img_display[$gallery['id']]=$gallery['thumb_img'];
															?>
                                                            <a title="<?=$photos[$i]['title'];?>" href="<?=base_url()?>uploads/galleries/<?php print md5("cdkgallery".$gallery['id']); ?>/thumb_gal/<?=$gallery['thumb_img']?>" class="img_display" >
                                                                <!--<img width="65%" src="<?=base_url()?>uploads/galleries/<?=md5("cdkgallery".$gallery['id'])?>/thumb_gal/<?=$gallery['thumb_img']?>" title="<?=$gallery['title']?>" />-->
                                                                	...
                                                                	<img class="hidden-phone" style="max-width:85%;" src="<?=base_url()?>uploads/galleries/<?=md5("cdkgallery".$gallery['id'])?>/thumb_gal/thumb/<?=$gallery['thumb_img']?>"  alt="" />
                                                                	<img class="visible-phone" style="width:100%;" src="<?=base_url()?>uploads/galleries/<?=md5("cdkgallery".$gallery['id'])?>/thumb_gal/thumb/<?=$gallery['thumb_img']?>"  alt="" />
                                                                
                                                            </a>
                                                            
                                                        <? }else{ 
                                                            $thumbnail = $this->Gallery_model->get_gallery_thumbnail($gallery['id']);
															$img_display[$gallery['id']]=$thumbnail;
                                                        ?>
                                                            <a title="<?=$gallery['title']?>" href="<?=base_url()?>uploads/galleries/<?php print md5("cdkgallery".$gallery['id']); ?>/<?=$thumbnail?>" class="img_display" >
                                                                <!--<img width="65%" src="<?=base_url()?>uploads/galleries/<?=md5("cdkgallery".$gallery['id'])?>/<?=$thumbnail?>" title="<?=$gallery['title']?>" />	-->
                                                                	...
                                                                	<img class="hidden-phone" style="max-width:85%;" src="<?=base_url()?>uploads/galleries/<?=md5("cdkgallery".$gallery['id'])?>/thumbnails/<?=$thumbnail?>"  alt="" />
                                                                    <img class="visible-phone" style="width:100%;" src="<?=base_url()?>uploads/galleries/<?=md5("cdkgallery".$gallery['id'])?>/thumbnails/<?=$thumbnail?>"  alt="" />
                                                    ...
                                                    <?
														...
														if($photos[$i]['video'] == 0 && $photos[$i]['name']!=$img_display[$gallery['id']]){?>
                                                        ...
                                                        <? }} ?>     
                                                  <br />                                                                                   	                                                
                                                <div class="gallery_title"><?=$gallery['title']?></div>
                                            </div>
                                        </div>  
                                <? }                                                                                                            
