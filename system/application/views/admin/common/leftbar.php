...
function heading_click(id)
{
	...
	if(active_head != id)
	{
		...
		jQuery('#heading'+id).css('background-color','rgba(0,0,0,0.25)');		
...
<div class="span3 bs-docs-sidebar">	
  ...
  <div class="accordion-group">
    <div class="accordion-heading" onclick="heading_click(10);" >
      <a id="heading10" class="accordion-toggle black-source nav-font <?php if(($curr_head == 'cms' && ($curr_page=='banner' || $curr_page=='stories' || $curr_page=='promotions' || $curr_page=='page' || $curr_page=='page_category' || $curr_page=='galleries' || $curr_page=='category' || $curr_page=='homepage')) || ($curr_head == 'gallery' && $curr_page=='galleries')){echo "header-bg-color";}?> aheading" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
        <span class="arrow" id="arrow10">
        	<?php
        		if(($curr_head == 'cms' && ($curr_page=='banner' || $curr_page=='stories' || $curr_page=='promotions' || $curr_page=='page' || $curr_page=='page_category' || $curr_page=='galleries' || $curr_page=='category' || $curr_page=='homepage')) || ($curr_head == 'gallery' && $curr_page=='galleries'))
				{
				?>
    ...
    <div id="collapseOne" class="accordion-body collapse <?php if(($curr_head == 'cms' && ($curr_page=='banner' || $curr_page=='stories' || $curr_page=='promotions' || $curr_page=='page' || $curr_page=='page_category' || $curr_page=='galleries' || $curr_page=='category' || $curr_page=='homepage')) || ($curr_head == 'gallery' && $curr_page=='galleries')){echo "in";}?>">
      ...
      <div class="accordion-inner <?php if($curr_page == 'tiles'){echo $active_page2;} else {echo $not_active_page2;}?>" id="inner-5">
        <a href="<?=base_url()?>admin/tiles" <?php if($curr_page == 'tiles'){echo $active_page;} else {echo $not_active_page;}?>><i class="icon-chevron-right"></i>Manage Tiles</a>
      </div> 
  ...
  <div class="accordion-group">
    <div class="accordion-heading" onclick="heading_click(1);" >
      <a id="heading1" class="accordion-toggle black-source nav-font <?php if(($curr_head == 'cms' && ($curr_page=='product' || $curr_page=='feature')) || $curr_head == 'position'){echo "header-bg-color";}?> aheading" data-toggle="collapse" data-parent="#accordion2" href="#collapseTen">
        <span class="arrow" id="arrow1">
        	<?php
        		if(($curr_head == 'cms' && ($curr_page=='product' || $curr_page=='feature')) || $curr_head == 'position')
				{
				?>
					<i class="icon-chevron-down"></i>
				<?
    ...
    <div id="collapseTen" class="accordion-body collapse <?php if(($curr_head == 'cms' && ($curr_page=='product' || $curr_page=='feature'))|| $curr_head == 'position'){echo "in";}?>">
      ...
      <div class="accordion-inner <?php if($curr_head == 'position'){echo $active_page2;} else {echo $not_active_page2;}?>" class="accordion-inner" id="inner-7">
  ...
  <div class="accordion-group" >
    ...
    <div id="collapseFour" class="accordion-body collapse <?php if($curr_head == 'customer'){echo "in";}?>">
      ...
      <!--admin/cms/call_survey-->
      <div class="accordion-inner <?php if($curr_page == 'survey'){echo $active_page2;} else {echo $not_active_page2;}?>" id="inner-2" >
      	<a target="_blank" style="display: block" href="#" <?php if($curr_page == 'survey'){echo $active_page;} else {echo $not_active_page;}?>> <i class="icon-chevron-right"></i>Manage Survey</a>
      </div>
      <!--admin/cms/call_email-->
      <div class="accordion-inner <?php if($curr_page == 'email'){echo $active_page2;} else {echo $not_active_page2;}?>" id="inner-3" >
      	<a target="_blank" style="display: block" href="#" <?php if($curr_page == 'email'){echo $active_page;} else {echo $not_active_page;}?>> <i class="icon-chevron-right"></i>Manage Customer Email</a>
      </div>
      <!--admin/cms/call_sms-->
      <div class="accordion-inner <?php if($curr_page == 'sms'){echo $active_page2;} else {echo $not_active_page2;}?>" id="inner-4" >
      	<a target="_blank" style="display: block" href="#" <?php if($curr_page == 'sms'){echo $active_page;} else {echo $not_active_page;}?>> <i class="icon-chevron-right"></i>Manage Customer SMS</a>
      </div>
...
<div style="margin-left: 0px; margin-bottom: 0px" class="accordion visible-phone" id="accordion2">
  ...
  <div class="accordion-group">
    ...
    <div id="collapseTen" class="accordion-body collapse <?php if($curr_head == 'cms' && ($curr_page=='product' || $curr_page=='feature') || ($curr_head == 'store' && $curr_page=='feature')){echo "in";}?>">
      ...
      <div class="accordion-inner <?php if($curr_head == 'position'){echo $active_page2;} else {echo $not_active_page2;}?>" class="accordion-inner" id="inner-7">
        <a href="<?=base_url()?>admin/position/" <?php if($curr_page == '' && $curr_head == 'position'){echo $active_page;} else {echo $not_active_page;}?>><i class="icon-chevron-right"></i>Manage Product Position</a>
      </div>
    </div>
  </div>
