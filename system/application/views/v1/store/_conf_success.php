	...
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="body-copy-Font">
				...
				<div style="float: left; width:200px;height:30px;">Your item(s) will be shipped to: </div>
				<div style="float: left; margin-left: 10px">
				...
				<div style="clear: both; height: 20px"></div>
				<div style="width:80%;">
					Thank you for placing an order with Bared, your credit card has been debited and you will receive tax invoice via email shortly. 
				...
				<div style="clear: both; height: 20px"></div>
				<div style="width:80%;">
					Should you have any questions or concerns please contact customer service by emailing <a class="body-copy-Font primarylink " href="mailto:info@bared.com.au">info@bared.com.au</a><br /> or calling +61 03 9509 5771.
				</div>
                <? 
