...
{		
	...
	jQuery.ajax({
		...
		type: 'POST',
		data: ({firstname:firstname,lastname:lastname, dob:dob, email:email, password:password, address1:address1, address2:address2, suburb:suburb, country:country, state:state, postcode:postcode}),
		dataType: "html",
...
function check_form()
{
	...
	{
		jQuery('#any_message').html('Your new password are not same');
