    ...
    <h4>SPENCER &amp; RUTHERFORD MELBOURNE CITY</h4>
   	...
   	<div class="row-fluid">
   		<div class="span6">
   			...
   			<div><span style="font-weight: 700">Address</span>: 279 Little Collins Street, Melbourne, VIC 3000</div>
   			<div><span style="font-weight: 700">Phone</span>: 03 9090 7053</div>
   			<div><span style="font-weight: 700">Email</span>: howey@spencerandrutherford.com</div>
   			<div><span style="font-weight: 700">Opening Hours</span>: Monday to Sunday, 10am to 6pm</div>
   			<div><i class="icon-3x icon-print"></i> &nbsp;&nbsp;&nbsp; <i class="icon-3x icon-envelope-alt"></i></div>
   		</div>
   		<div class="span6">
