...
<div class="container">
		    ...
		    <form class="form-horizontal">
			    <div class="control-group">
				    <label class="label-form-Font control-label" for="title">
				    	<div style="margin-left: 30px" class="header-form">
				    		Title:
				    	</div>
				    </label>
				    <div class="controls">
	...
	<div class="row-fluid">
		...
		<div class="span6">
			<div class="account-header body-copy-Font">Shipping Address (<a  class="body-copy-Font account-header-link" href="javascript:use_billing_address();">Use billing address</a>)</div>
			
			<form class="form-horizontal" method="post" action="<?=base_url()?>cart/save_account_page" id="form-acc" onsubmit="return check_phone();">
			    <div class="control-group">
			    ...
			    <div class="control-group">
				    <div class="controls">
				    	<button type="submit" style="float: right;" class="span10 button-Font button_primary">
				    		Continue
				    	</button
				    ></div>
			    </div>
