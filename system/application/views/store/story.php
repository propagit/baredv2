							   	...
							   	if($now == 1){   ?> 
                                        ...
                                        <div class="span4" style="margin-left:0px!important;">
                                            <div style="text-align: center;">                                            	
                                                <? if($cat=='all'){ 
                                                	if($st==-1){?> <a href="http://bared.com.au/store/stories_new/latest season">  <? }else{?> 
                                                   <? if($st==10){?><a href="http://bared.com.au/store/stories_new/single_all/<?=$st?>"><? }else{?>
                                                    <a href="http://bared.com.au/store/stories_new/single_all/<?=$st?>">
                                                    <? }?>
                                                    <? }?>
                                                <? } else { ?>
                                                
                                                <a href="http://bared.com.au/store/stories_new/cat_all/<?=$st?>"> 
                                                <? } ?>
                                                	<? if($pr_image){?>
                                                ...
                                                <? if($cat=='all'){ ?>
                                                	<? if($st==10){?><a href="http://store/stories_new/single_all/<?=$st?>"><? }else{?>
                                                    <a href="http://bared.com.au/store/stories_new/single_all/<?=$st?>">
                                                    <? }?>
                                                <? } else {?>  
                                                <a href="http://bared.com.au/store/stories_new/cat_all/<?=$st?>"> 
                                ...
                                if($now == 3){   ?>                                                                                                           
                                        <div class="span4" style="float:left;margin-left:0px!important;">
                                            <div style="text-align: center;">
                                                ...
                                                <? if($cat=='all'){ 
                                                if($st==-1){?> <a href="http://bared.com.au/store/stories_new/latest season">  <? }else{?> 
                                                   <? if($st==10){?><a href="http://bared.com.au/store/stories_new/single_all/<?=$st?>">
												   <? }else{?>
                                                    <a href="http://bared.com.au/store/stories_new/single_all/<?=$st?>">
                                                    <? }?>
                                                    <? }?>
