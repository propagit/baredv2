...
<!-- <fb:login-button show-faces="true" width="200" max-s="1"></fb:login-button> -->
		...
		<tr>
			<td style="padding: 10px; width: 50%">
				...
				if($id)
				{
					...
					?>
					<img style="width:100%" src="<?=base_url()?>uploads/products/<?=md5('mbb'.$product['id'])?>/thumb1/<?=$hero['name']?>"/>
					<?
				}
				else 
				{
			...
			<td style="padding: 30px; width: 50%; vertical-align: top">
				...
				<p style="font-style: normal">
					GIFT AMOUNT<br/>
					<span style="font-weight: 700; font-size: 18px;">AU $ <?=$amount?></span><br/>
					<br/>
					ENTER CODE AT CHECKOUT<br/>
					<span style="font-weight: 700; font-size: 18px;">AAPT375</span><br/>
					<br/>
					VALID UNTIL<br/>
					<span style="font-weight: 700; font-size: 18px;">DD/MM/YYYY</span>
				</p>
			</td>
		</tr>
	</table>
	...
	<table width="630px" align="center" cellpadding="0" cellspacing="0" style="margin-top: 30px; font-size: 16px; color: #403c3c; font-family: times; ">
		<tr>
			<td>
				Dear <?=$recipient?>,<br/>
				<br/>
				<?=$sender?> has sent you a Gift Voucher to spend on something special from <?=COMPANY_NAME?>. Your Gift Voucher can be redeemed online at <a href="<?=base_url()?>"><?=COMPANY_WEBSITE?></a> and is valid for 12 months.<br/>
				<br/>
				...
				<ol>
					<li>Go to <a href="<?=base_url()?>"><?=COMPANY_WEBSITE?></a></li>
				...
				Gift Vouchers are valid for 12 months from the date of purchase and can only be used in the <?=COMPANY_NAME?> eBoutique.<br/>
			</td>
		</tr>
	</table>
	...
	<!-- <table cellspacing="0" cellpadding="0" width="630" align="center" style="margin-top: 20px">
		...
		<table width="630px" align="center" cellpadding="0" cellspacing="0" style="margin-top:20px; font-size: 16px; color: #403c3c; font-family: times; border-top: 5px solid #000">
		<tr>
			<td>
			</td>
		</tr>
