...
<div class="left">
    ...
    <div class="bar">
        <div class="text">Photo Details</div>
        <div class="cr"></div>
    </div>
    <div class="content-area">
            ...
            <ul>
                <li>
                    <a href="<?=base_url()?>uploads/galleries/<?php print md5("cdkgallery".$gallery['id']); ?>/<?=$src?>">
                        <img style="border:5px solid #fff;" src="<?=base_url()?>uploads/galleries/<?php print md5("cdkgallery".$gallery['id']); ?>/thumbnails/<?=$src?>" alt="" />
                    </a>
                </li>
            </ul>
        </div>
        ...
        Photo Image Caption
        <p><input style="margin-top:10px; width:350px; margin-bottom:53px;" type="text" name="title" class="medium" value="<?=$photo['title']?>" /></p>
