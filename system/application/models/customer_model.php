...
class Customer_model extends Model {
	...
	{
		$sql = "select sum(total) as ttl, customer_id from `orders` where customer_id = $id and (order_status = 'completed' or order_status='processed') group by customer_id, status";
		$query = $this->db->query($sql);
