...
curl_setopt($curl, CURLOPT_URL, "https://api.merchantos.com/API/Account/$account_id/Item.xml?load_relations=all&ItemShops.timeStamp=%3E,2013-08-12T08:20:58&archived=0&limit=100&offset=0&Category.parentID=7");
...
<?php foreach($xmlNew2 as  $purge) { 
		...
		/*print_r($category);
		echo '<br><br>';	
		echo 'ID : '.$category->itemID.'<br>';
		echo 'Name : '.$category->description.'<br>';
		echo 'Price : '.$category->ItemPrice['amount'].'<br>';
		echo 'Quantity : '.$category->ItemShops->qoh.'<br>';
		echo '<br><br>';	*/
