...
class RESTConnector {
    ...
    public function createRequest($url, $method, $body = null, $mycookies) {
		...
		$this->req->setHeader("User-Agent", "[INSERT YOUR PUBLIC APP ID HERE]/[INSERT YOUR APP VERSION NUMBER HERE]");
        
        // We also need to send our App Private ID in a header called X-PAPPID
		$this->req->setHeader("X-PAPPID", "[INSERT YOUR PRIVATE APP ID HERE]");
        
        // A valid username and password must also be sent to connect correctly
        $this->req->setAuth("lightspeed", "admin");
